...
public class Account {
	...
	private double additionalLineRate() {
		return 	additionalLineRateForStandardLines() + 
				additionalLineRateForFamilyLines();
	}

	private double additionalLineRateForFamilyLines() {
		if (numberOfLines > MAX_STANDARD_LINES)
			return (numberOfLines - MAX_STANDARD_LINES) * FAMILY_DISCOUNT;
		return 0.0;
	}

	private double additionalLineRateForStandardLines() {
