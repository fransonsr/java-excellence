...
public interface AssetReportConstants {
	...
	static final String ISSUE_FAMILY = "ISSUE_FAMILY";
	static final String ISSUE_GROUP = "ISSUE_GROUP";

	static final String QUANTITY = "QUANTITY";
	static final String MARKET_PRICE = "MARKET_PRICE";

	static final String FUND_PER_UNIT_COST = "TERM_ONE";
	static final String EQUITY_TOTAL_COST = "TERM_ONE";

	static final String FUND_ASSESSED_RISK = "TERM_TWO";
