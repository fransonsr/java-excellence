...
public class AssetReportTest {
	...
	public void setUp() {
		records = new RecordSet(new String[] {
				"ISSUE_GROUP", "ISSUE_FAMILY", "ISSUE_NAME", "QUANTITY", "MARKET_PRICE", "TERM_ONE", "TERM_TWO" });
		report = new AssetReport(new FakeRiskAssessor());
	}

	@Test
	public void singleEquity() throws Exception {
		records.addRow(new String[] { "Equities", "family", "Equity", QUANTITY_10, MARKET_PRICE_2, TOTAL_COST_4, RISK_75 });
	...
	public void singleMoneyMarket() throws Exception {
		records
				.addRow(new String[] { "Funds", "FUND", "Fund", QUANTITY_10, MARKET_PRICE_2, PER_UNIT_COST_1, RISK_CEILING_10 });
	...
	public void mixed() throws Exception {
		records.addRow(new String[] { "Assets", "family", "Equity", QUANTITY_10, MARKET_PRICE_2, TOTAL_COST_4, RISK_75 });
		records
				.addRow(new String[] {
						"Assets", "family", "Fund", QUANTITY_10, MARKET_PRICE_2, PER_UNIT_COST_1, RISK_CEILING_10 });
	...
	public void sameTypeSameGroup() throws Exception {
		...
		records.addRow(new String[] { "Alpha", "family", "Beta Equity", QUANTITY_10, MARKET_PRICE_2, TOTAL_COST_4, RISK_75 });
		records.addRow(new String[] { "Alpha", "family", "Delta Equity", QUANTITY_10, MARKET_PRICE_2, TOTAL_COST_4, RISK_75 });
